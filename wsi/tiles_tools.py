...
#                                t.r, t.c, t.o_c_s, t.o_r_s, t.o_c_e - t.o_c_s, t.o_r_e - t.o_r_s) + "." + DEST_TRAIN_EXT)
    ...
    tile_filename = slide_type_id + tile_pos_id + ENV.PIL_IMAGE_FILE_FORMAT
...
class Tile:
    ...
    def get_ihc_dab_np_tile(self, preload_slide=None):
        ...
        '''
        pil_tile = tile_to_pil_tile(self, preload_slide)
        pil_tile_dab = pil_rgb_2_ihc_dab(pil_tile)
        return image_tools.pil_to_np_rgb(pil_tile_dab)
...
def get_slide_tiles(np_scaled_img, shape_set_img, original_slide_filepath,
    ...
    float_scale_factor = l_slide_w / s_slide_w
    ...
    for t_idx in tile_idxs:
        ...
        large_w_s, large_h_s = slide_tools.small_to_large_mapping((small_w_s, small_h_s))
        large_w_e, large_h_e = slide_tools.small_to_large_mapping((small_w_e, small_h_e))
